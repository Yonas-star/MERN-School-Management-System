...
const StudentSideBar = () => {
    ...
    const menuItems = [
        ...
        { text: 'Subjects', icon: <SubjectIcon />, path: '/Student/subjects' },
        { text: 'Attendance', icon: <ClassIcon />, path: '/Student/attendance' },
        { text: 'Complaints', icon: <AnnouncementIcon />, path: '/Student/complain' }
    ];
